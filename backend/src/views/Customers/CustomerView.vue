        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <CustomInput v-if="billingCountry && !billingCountry.states" v-model="customer.billingAddress.state"
                           label="State" :errors="errors['billingAddress.state']"/>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              ...
              <CustomInput v-if="shippingCountry && !shippingCountry.states" v-model="customer.shippingAddress.state"
                           label="State"
      ...
      <footer class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button type="submit"
                class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm
                          hover:text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500">
          Submit
        </button>
